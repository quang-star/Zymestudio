                ...
                <div class="card z-index-2">
                    <div class="card-body p-2">
                        <div class="bg-dark border-radius-md py-3 pe-1 mb-3">
                            <div class="chart">
                                <canvas id="chart-bars" class="chart-canvas" height="212" width="589"
                                    style="display: block; box-sizing: border-box; height: 170px; width: 471px;"></canvas>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-3">
                        <div class="chart">
                            <canvas id="chart-line" class="chart-canvas" height="375" width="832"
                                style="display: block; box-sizing: border-box; height: 300px; width: 666px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
